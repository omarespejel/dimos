...
all_blueprints = {
    ...
    "unitree-go2-agentic-sim": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_agentic_sim:unitree_go2_agentic_sim",
    ...
    "unitree-go2-replay": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_replay:unitree_go2_replay",
    ...
    "unitree-go2-sim": "dimos.robot.unitree.go2.blueprints.smart.unitree_go2_sim:unitree_go2_sim",
