...
all_blueprints = {
    ...
    "sim-agentic": "dimos.robot.sim.blueprints.agentic.sim_agentic:sim_agentic",
    "sim-basic": "dimos.robot.sim.blueprints.basic.sim_basic:sim_basic",
    "sim-eval": "dimos.robot.sim.blueprints.agentic.sim_eval:sim_eval",
    "sim-nav": "dimos.robot.sim.blueprints.nav.sim_nav:sim_nav",
    "sim-parallel-eval": "dimos.robot.sim.blueprints.agentic.sim_parallel_eval:sim_parallel_eval",
    "sim-spatial": "dimos.robot.sim.blueprints.nav.sim_spatial:sim_spatial",
    "sim-temporal-memory": "dimos.robot.sim.blueprints.agentic.sim_temporal_memory:sim_temporal_memory",
    ...
    "unitree-go2-dimsim": "dimos.robot.unitree.go2.blueprints.basic.unitree_go2_dimsim:unitree_go2_dimsim",
