...
all_blueprints = {
    ...
    "unitree-go2-nav-onboard": "dimos.robot.unitree.go2.blueprints.navigation.unitree_go2_nav_onboard:unitree_go2_nav_onboard",
...
all_modules = {
    ...
    "pose-stamped-to-odometry": "dimos.robot.unitree.go2.odom_adapter.PoseStampedToOdometry",
    ...
    "rtab-map": "dimos.navigation.nav_stack.modules.rtab_map.rtab_map.RtabMap",
