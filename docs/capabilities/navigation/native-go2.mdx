<img src="native/assets/noros_nav.gif" width="100%" />
...
```pikchr fold output=native/assets/go2nav_dataflow.svg
color = white
fill = none
...
{/* Result: */}
<img alt="output" src="native/assets/go2nav_dataflow.svg" />
## Pipeline Steps
...
<img alt="LiDAR frame" src="native/assets/1-lidar.png" />
...
<img alt="Global map" src="native/assets/2-globalmap.png" />
...
<img alt="Global costmap" src="native/assets/3-globalcostmap.png" />
...
<img alt="Navigation costmap with path" src="native/assets/4-navcostmap.png" />

### 5. All Layers Combined

All visualization layers shown together

<img alt="All layers" src="native/assets/5-all.png" />
...
|----------|----------|--------|
| <img alt="coverage" src="native/assets/coverage.png" /> | <img alt="frontier" src="native/assets/frontier.png" /> | <img alt="random" src="native/assets/random.png" /> |

### Sample patrol trace (26 min)

<img alt="Patrol path" src="native/assets/patrol_path.png" />
...
```python fold output=native/assets/go2_blueprint.svg
...
to_svg(unitree_go2, "native/assets/go2_blueprint.svg")
```

{/* Result: */}
<img alt="output" src="native/assets/go2_blueprint.svg" />
