...
<img alt="go2_nav" src="../assets/go2_nav.svg" />
...
<img alt="Benchmark results" src="../assets/pubsub_benchmark.png" />
...
{/* Result: */}
<img alt="output" src="../assets/abstraction_layers.svg" />
...
<img alt="lcmspy" src="../assets/lcmspy.png" />
