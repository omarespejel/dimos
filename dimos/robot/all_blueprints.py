...
all_blueprints = {
    ...
    "r1pro-dual-mock": "dimos.robot.humanoids.r1pro.blueprints:r1pro_dual_mock",
    ...
    "r1pro-planner-coordinator": "dimos.robot.humanoids.r1pro.blueprints:r1pro_planner_coordinator",
