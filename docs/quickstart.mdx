...
Blueprint reference: [Blueprints](/usage/blueprints).
...
Full reference: [CLI](/usage/cli).

## What next?

<CardGroup cols={2}>
  <Card title="Add an LLM agent" href="/capabilities/agents" icon="robot">
    Natural language control and MCP-exposed skills.
  </Card>
  <Card title="Pick your platform" href="/platforms/quadruped-go2" icon="microchip">
    Hardware support matrix and bring-up guides.
  </Card>
  <Card title="Core concepts" href="/usage/concepts" icon="diagram-project">
    Modules, streams, and blueprints behind every workflow.
  </Card>
  <Card title="Capabilities" href="/capabilities/agents" icon="bolt">
