...
# the Stream-shaped API in pgo.py — pgo_keyframes, keyframes_to_corrections,
# make_interpolator, apply_corrections. The classes here (_SimplePGO,
# PGOConfig, _KeyPose) are imported from pgo to do the heavy lifting.
