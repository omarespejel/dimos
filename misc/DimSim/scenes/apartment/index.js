...
//
// Static structure (walls, floor, ceiling, fixtures) lives in ./structure.glb,
// baked once from the original primitives via cli/export-structure.ts.
// Interactive objects (fridge, cabinets, TV, etc.) live as GLB-per-state files
// under ./objects/, generated by cli/export-apartment.ts. Sky, lights, and tags
// are inlined here so the scene is fully imperative — no data/ files needed.
